//
//  SYBMasterViewControllerTableViewController.swift
...
class SYBMasterViewControllerTableViewController: UITableViewController {
   ...
   override func viewDidLoad() {
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        let ventana2VC = self.storyboard?.instantiateViewControllerWithIdentifier("viewDetail2") as! SYBDetailViewController
