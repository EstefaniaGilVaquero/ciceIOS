//
//  DPConsultoriaEmpresarialViewController.swift
//  AppCoreData_GDP
//
...
class DPConsultoriaEmpresarialViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //Vete a tomar por saco y actuliza//prueba1
        ...
        for indiceFotos in 0..<10{
            let imagenesSerJur = UIImageView(image: UIImage(named: NSString(format: "CE_%d.jpg", indiceFotos)as String))
        ...
        myCustomScrollView.contentSize = CGSizeMake(9 * 540, 352)
        myCustomScrollView.pagingEnabled = true
        
        myCustomPageControll.numberOfPages = 9
...
extension DPConsultoriaEmpresarialViewController : UIScrollViewDelegate{
